...
const IngredientModal = ({
  ...
  const categoryUnits =
    unitsByCategory[form.category] || Object.values(unitsByCategory).flat();
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
        <div className="flex items-start gap-2">
          ...
          <p className="text-sm text-blue-800">
            <span className="font-medium">Note:</span> Expiration dates are now managed per batch during stock-in operations. Each batch will have its own expiration date for better inventory tracking.
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
        <div className="flex items-start gap-2">
          ...
          <p className="text-sm text-amber-800">
            <span className="font-medium">Note:</span> Changing the name will
            check for duplicates. Trailing spaces are automatically trimmed.
          </p>
        </div>
      </div>
    )}
